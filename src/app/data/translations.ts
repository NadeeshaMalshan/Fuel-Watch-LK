...
export const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    // Station fuel alerts (browser notifications while site is open)
    'notify.enable': 'Notify me when fuel is reported here',
    'notify.disable': 'Stop alerts for this station',
    'notify.enabled': 'Alerts on for this station',
    'notify.disabled': 'Alerts turned off',
    'notify.unsupported': 'This browser does not support notifications',
    'notify.permissionDenied': 'Notification permission was denied',
    'notify.settingsTitle': 'Fuel alerts',
    'notify.settingsHint':
      'We check for new community reports about every 45 seconds while FuelAlert stays open (browser tab or installed app). Alerts need an internet connection.',
    'notify.empty': 'No stations yet. Open a station and tap the bell in the header.',
    'notify.remove': 'Remove',
    'notify.reportedBy': 'Reported by',
    'notify.overall': 'Overall',
    'notify.note': 'Note',
    'notify.anonymousReporter': 'Community member',
    'notify.communityReported': 'Community reported',
    'notify.is': 'is',
    'notify.by': 'by',
    'notify.and': 'and',
    'notify.multiFrom': 'Community report from',
  ...
  si: {
    ...
    'notify.enable': 'මෙහි ඉන්ධන ගැන දැනුම් දෙන්න',
    'notify.disable': 'මෙම පිරවුම්හලට දැනුම්දීම් නවත්වන්න',
    'notify.enabled': 'මෙම පිරවුම්හලට දැනුම්දීම් සක්‍රීයයි',
    'notify.disabled': 'දැනුම්දීම් අක්‍රීය කළා',
    'notify.unsupported': 'මෙම බ්‍රව්සරය දැනුම්දීම් සඳහා සහය නොදක්වයි',
    'notify.permissionDenied': 'දැනුම්දීම් වලට අවසරය ලැබුණේ නැහැ',
    'notify.settingsTitle': 'ඉන්ධන දැනුම්දීම්',
    'notify.settingsHint':
      'FuelAlert බ්‍රව්සර් ටැබ් එකේ හෝ ස්ථාපනය කළ යෙදුමේ විවෘතව තිබෙද්දී සම්මත වශයෙන් තත්පර 45කට වරක් නව ප්‍රජා වාර්තා සොයා බලනවා. අන්තර්ජාල සම්බන්ධතාවය අවශ්‍යයි.',
    'notify.empty': 'තවම පිරවුම්හල් නැහැ. පිරවුම්හලක් විවෘත කර ශීර්ෂයේ ඇති සීනුව ඔබන්න.',
    'notify.remove': 'ඉවත් කරන්න',
    'notify.reportedBy': 'වාර්තා කළේ',
    'notify.overall': 'සමස්ත තත්ත්වය',
    'notify.note': 'සටහන',
    'notify.anonymousReporter': 'ප්‍රජා සාමාජිකයෙක්',
    'notify.communityReported': 'ප්‍රජාව වාර්තා කළේ',
    'notify.is': '',
    'notify.by': 'විසින්',
    'notify.and': 'සහ',
    'notify.multiFrom': '',
  ...
  ta: {
    ...
    'notify.enable': 'இங்கு எரிபொருள் பற்றி அறிவிக்கவும்',
    'notify.disable': 'இந்த நிலையத்திற்கான அறிவிப்புகளை நிறுத்து',
    'notify.enabled': 'இந்த நிலையத்திற்கு அறிவிப்புகள் இயக்கப்பட்டன',
    'notify.disabled': 'அறிவிப்புகள் முடக்கப்பட்டன',
    'notify.unsupported': 'இந்த உலாவி அறிவிப்புகளை ஆதரிக்கவில்லை',
    'notify.permissionDenied': 'அறிவிப்பு அனுமதி மறுக்கப்பட்டது',
    'notify.settingsTitle': 'எரிபொருள் அறிவிப்புகள்',
    'notify.settingsHint':
      'FuelAlert உலாவி தாவலில் அல்லது நிறுவப்பட்ட பயன்பாட்டில் திறந்திருக்கும்போது சுமார் 45 விநாடிகளுக்கு ஒருமுறை புதிய சமூக அறிக்கைகளைச் சரிபார்க்கிறோம். இணைய இணைப்பு தேவை.',
    'notify.empty': 'இன்னும் நிலையங்கள் இல்லை. ஒரு நிலையத்தைத் திறந்து தலைப்பில் உள்ள மணியைத் தட்டவும்.',
    'notify.remove': 'நீக்கு',
    'notify.reportedBy': 'அறிவித்தவர்',
    'notify.overall': 'மொத்த நிலை',
    'notify.note': 'குறிப்பு',
    'notify.anonymousReporter': 'சமூக உறுப்பினர்',
    'notify.communityReported': 'சமூகம் அறிவித்தது',
    'notify.is': '',
    'notify.by': 'மூலம்',
    'notify.and': 'மற்றும்',
    'notify.multiFrom': '',
